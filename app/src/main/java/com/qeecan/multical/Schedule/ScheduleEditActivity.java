...
public class ScheduleEditActivity extends AppCompatActivity {
    ...
    private Button btnTime, btnDate,btnCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openModel = ob.getInt("mode");//mode 5是编辑，4是添加
    ...
    private void init() {
        ...
        btnCancel=findViewById(R.id.alarm_btn_cancel);
            ...
            switch (v.getId()) {
                ...
                case R.id.alarm_edit_iv_check:
                    if (!canBeSet() || contentEt.getText().toString().length() == 0) {
                        Toast.makeText(ScheduleEditActivity.this, "内容或时间有错误，请修改", Toast.LENGTH_SHORT).show();
                    } else {
                        //进入模式选择
                        modelSelect();
                        /*setResult(RESULT_OK, intent);*/
                        Intent intent1 = new Intent(ScheduleEditActivity.this,ScheduleActivity.class);
