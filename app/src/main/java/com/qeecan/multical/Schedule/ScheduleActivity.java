...
import com.qeecan.multical.CalActivity;
...
public class ScheduleActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    //监听floatingactionbutton按钮进行跳转操作
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.cal_back:
                    ...
                    intent1.setClass(ScheduleActivity.this, CalActivity.class);
...
/*    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK) {//更新当前日程
            ...
            sd.close();
        } else if(resultCode == RESULT_CANCELED){//取消添加或者编辑
